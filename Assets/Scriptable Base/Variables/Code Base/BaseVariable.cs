...
namespace Variable
{
    //Abstract - The abstract keyword enables you to create classes and class members that are incomplete and must be implemented in a derived class. (Child class)
                                        //Family Genes
